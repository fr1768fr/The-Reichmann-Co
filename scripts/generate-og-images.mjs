...
const CARDS = [
  ...
  },
  {
    ...
    tagline: 'Fast, accessible, modern.',
    sub: 'Web apps that perform on every device.',
    url: 'thereichmannco.co.za/services/web-applications',
  },
  {
    slug: 'mobile-apps',
    eyebrow: 'THE REICHMANN CO.',
    title: 'Mobile Apps',
    tagline: 'Native iOS and Android.',
    sub: 'From MVP to App Store launch.',
    url: 'thereichmannco.co.za/services/mobile-apps',
  },
  {
    slug: 'saas-products',
    eyebrow: 'THE REICHMANN CO.',
    title: 'SaaS Products',
    tagline: 'SaaS, end to end.',
    sub: 'Auth, billing, infrastructure, and the product.',
    url: 'thereichmannco.co.za/services/saas-products',
  },
  {
    slug: 'desktop-software',
    eyebrow: 'THE REICHMANN CO.',
    title: 'Desktop Software',
    tagline: "When the browser won't do.",
    sub: 'Native apps for Windows, macOS, and Linux.',
    url: 'thereichmannco.co.za/services/desktop-software',
  },
  {
    slug: 'cloud-backend',
    eyebrow: 'THE REICHMANN CO.',
    ...
    sub: 'APIs, infrastructure, and observability.',
    url: 'thereichmannco.co.za/services/cloud-backend',
  },
  {
    ...
    sub: 'LLM features, automation, and integrations.',
    url: 'thereichmannco.co.za/services/ai-integrations',
  },
];
